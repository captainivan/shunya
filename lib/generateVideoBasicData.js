...
### PREVIOUS SONG (FORBIDDEN ZONE Do NOT repeat ANY part of its style, tone, themes, structure, metaphors, emotional arc, rhyme behavior, naming patterns, or worldbuilding.)
${JSON.stringify(songDetails, null, 2).replace(/`/g, "'")}


### FROM HERE WE WILL START GENERTAION OF NEW SONG COMPLETLY DIFFRENT FROM ABOVE SONG(JSON)
